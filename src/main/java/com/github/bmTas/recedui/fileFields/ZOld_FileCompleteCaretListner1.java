 ...
 *
 */
public class ZOld_FileCompleteCaretListner1 implements CaretListener {
	...
	private MouseMonitor dialogMonitor = new MouseMonitor(true) {
	...
	public ZOld_FileCompleteCaretListner1(
